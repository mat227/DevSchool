    ...
    return(
        ...
        <div class="lateralEsquerda">
            ...
            <div class="lateralEsquerda-gerente">
                ...
                <img src="/DevSchool/html/src/assets/imagens/setaparabaixo.svg" />
            </div>
        ...
        <div class="box-direira">
            <header class="cabecalho-box-direira">
                <div class="usuario">
                    <img src="/DevSchool/html/src/assets/imagens/imgmat.png">
                    <div class="divDentroIMG">3</div>
                    </img>
                    <div>Olá, <span>Matheus Oliveira</span></div>
                </div>
                <div class="botoes1">
                    <button> <img src="/DevSchool/html/src/assets/imagens/atualizar.svg" /></button>
                    <button> <img src="/DevSchool/html/src/assets/imagens/log-out.svg" /></button>
                </div>
            </header>
                    ...
                    <table class="tabela-matriculados">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td> InfoC </td>
                                <td> Informática </td>
                                <td> <button> <img src="/DevSchool/html/src/assets/imagens/edit.svg" alt="" /> </button>
                                </td>
                                <td class="imgs-delet-edit"> <button> <img
                                            src="/DevSchool/html/src/assets/imagens/trash-2.svg" alt="" /> </button>
                                </td>
                            </tr>
                            <tr class="info">
                                <td> 2 </td>
